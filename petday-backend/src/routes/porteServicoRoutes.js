...
router.put('/:servico_id/:porte_id',
    validarCamposObrigatorios([ 'servico_id', 'porte_id', 'preco_porte' ]),
    porteServicoController.atualizarPreco
);

router.get('/:servico_id',
    porteServicoController.listarPrecoPorServico
);
